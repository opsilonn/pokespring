...
describe('DELETE /api/v1/interest-points/:id', () => {
  let agent
  ...
  it('should return the status 200 if we are authenticated as a user who can edit the universe of the selected interestPoint', async () => {
    ...
    return agent
      .delete(`/api/v1/interest-points/${interestPoint.id}`)
      .expect(200)
  })
  ...
  it('should return the status 401 if the selected interestPoint doesn\'t exists', async () => {
    ...
    return agent
      .delete('/api/v1/interest-points/1')
      .expect(401)
  })
