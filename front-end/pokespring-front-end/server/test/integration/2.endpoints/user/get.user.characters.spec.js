...
describe('GET /api/v1/users/:id/characters', () => {
  let agent
  ...
  it('should return the list of all the characters of the selected user', async () => {
  ...
  it('should return an empty list of characters if the selected user doesn\'t exists', () =>
    agent
      .get('/api/v1/users/1/characters')
      .expect(200)
      .expect('Content-Type', /json/)
      .then((response) => {
        expect(response.body._links).to.have.all.keys(['self'])
