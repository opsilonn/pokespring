...
describe('DELETE /api/v1/template-categories/:id', () => {
  let agent
  ...
  it('should return the status 200 if we are authenticated as a user who can edit the universe of the selected templateCategory', async () => {
    ...
    return agent
      .delete(`/api/v1/template-categories/${templateCategory.id}`)
      .expect(200)
  })
  ...
  it('should return the status 401 if the selected templateCategory doesn\'t exists', async () => {
    ...
    return agent
      .delete('/api/v1/template-categories/1')
      .expect(401)
  })
