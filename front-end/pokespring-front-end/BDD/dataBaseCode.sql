...
-- Listage de la structure de la base pour otter_worlds
CREATE OR REPLACE DATABASE `otter_worlds` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `otter_worlds`;

-- Listage de la structure de la table otter_worlds. article
...
-- Listage de la structure de la table otter_worlds. character
...
-- Listage de la structure de la table otter_worlds. characteringroup
...
-- Listage de la structure de la vue otter_worlds. characterstats
...
-- Listage de la structure de la table otter_worlds. event
...
-- Listage de la structure de la table otter_worlds. group
...
-- Listage de la structure de la table otter_worlds. interestpoint
...
-- Listage de la structure de la table otter_worlds. inventory
...
-- Listage de la structure de la table otter_worlds. keyword
...
-- Listage de la structure de la table otter_worlds. map
...
-- Listage de la structure de la table otter_worlds. session
...
-- Listage de la structure de la table otter_worlds. stat
...
-- Listage de la structure de la table otter_worlds. subtopic
...
-- Listage de la structure de la table otter_worlds. templatecategory
...
-- Listage de la structure de la table otter_worlds. templatestat
...
-- Listage de la structure de la table otter_worlds. timeline
...
-- Listage de la structure de la table otter_worlds. topic
...
-- Listage de la structure de la table otter_worlds. universe
...
-- Listage de la structure de la table otter_worlds. user
...
-- Listage de la structure de la vue otter_worlds. userinuniverse
...
-- Listage de la structure de la table otter_worlds. userinvitation
